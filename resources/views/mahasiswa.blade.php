    ...
    <div class="container">
        <div class="flex">
            <div class="w-auto md:w-3/4 text-center bg-white shadow-lg text-white py-16 rounded-md px-6 mr-6 mt-6 ">
                ...
                <p class="text-black justify-center"><strong>Dosen wali:</strong> Dr. Prof. Dosen, S.Kom., M.Kom.</p><p class="text-black justify-center mb-10"><strong>NIP:</strong> 24060123456345</p>
